...
echo "# SocialHub-Full-Stack-PERN-JavaScript-Typescript"
git init
git add *
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/roone858/SocialHub-Full-Stack-PERN-JavaScript-Typescript.git
